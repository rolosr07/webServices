...
<div class="container-fluid">
    <div class="quick-actions_homepage">
        <ul class="quick-actions">
            ...
            <li class="bg_lg span3"> <a href="_librosPendientes.php"> <i class="icon-book"></i> Libros Pendientes</a> </li>
            ...
            <li class="bg_ls"> <a href="_flores.php"> <i class="icon-leaf"></i> Alta Flores</a> </li>
        </ul>
    </div>
    <!--End-Action boxes-->
    <hr/>
